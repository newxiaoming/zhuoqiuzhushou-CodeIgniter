        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>players/addNew"><i class="fa fa-plus"></i> 添加</a>
                </div>
            </div>
        </div>
        <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    {
                        foreach($playersList as $record)
                        {
                    ?>
                    <tr>
                      <td><?php echo $record->id ?></td>
                      <td><?php echo $record->name ?></td>
                      <td><?php echo $record->brokerage ?></td>
                      <td><?php echo $record->odds ?></td>
